...
Terminal commands, used by the Terminal Agent, are the primary way the Cypher Swarm interacts with the system and external services. This guide will walk you through creating new terminal commands.
