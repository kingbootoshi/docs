Before you can start using Cypher Swarm, you'll need to set up your Supabase database with the required schema. This guide will walk you through the process.

## Prerequisites

1. A Supabase account and project
2. Access to your project's SQL editor
...
4. Execute the SQL code to create all necessary tables and setup security policies
...
After executing the SQL code:

1. Check that all tables have been created successfully
2. Verify that Row Level Security (RLS) policies are in place
3. Confirm that indexes have been created for optimal performance

## Next Steps

Once your database is set up, you can proceed with the rest of the setup process in the [Quickstart](/quickstart) guide. 